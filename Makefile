...
#    Updated: 2024/03/29 11:45:13 by mconreau         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PROJECT_SOURCES			:=	$(addprefix $(FOLDER_SOURCES)/, ft_printf.c			\
							process/ft_process_c.c								\
							process/ft_process_d.c								\
							process/ft_process_i.c								\
							process/ft_process_p.c								\
							process/ft_process_s.c								\
							process/ft_process_u.c								\
							process/ft_process_x.c								\
							structures/st_flg.c									\
							structures/st_tkn.c									\
							ft_convert.c										\
							ft_output.c											\
